...
In this application, it is also possible to search for a student by name, surname, or field of study.

<img width="1247" height="646" alt="Capture dՎcran du 2026-03-18 11-35-24" src="https://github.com/user-attachments/assets/cb5b705e-c9c1-4d76-8baf-5e7a5028360e" />
...
. Clone the repository by typing:
  git clone git@github.com:NgassamJoyce/Student_Management.git

. Unzip the folder

. Open the folder and double-click on the "index.html" file
...
.To edit a student's information or permanently delete a student, click the "Edit" or "Delete" buttons in the "Action" column.

.To search for a specific student, go to "Search Student" and enter the student's name, surname, or field of study.
